...
export const registerItem = (
  ...
  // add all the promise dependencies
...
export const getDataList = async (
  ...
  // transform data for front end to process
...
// delete image and return it as a promise
